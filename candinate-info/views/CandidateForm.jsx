                            ...
                            <div className="form-group">
                                <label className="col-md-4 control-label"></label>
                                    <div className="col-md-6">
                                        { !modalLabelView && !modalEditView &&
                                            <button className="btn btn-info">Submit<span className="glyphicon glyphicon-submit"></span></button>
                                        }  
                                        { !modalLabelView && modalEditView &&
                                            <button className="btn btn-info" onClick={(e) => this.handleUpdate(e, candidate._id, candidate)}>Update<span className="glyphicon glyphicon-update"></span></button>
                                        }  
                                        { modalLabelView && !modalEditView &&
                                            <EditButton 
